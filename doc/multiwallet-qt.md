...
In order to support loading of multiple wallets in csocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is csocoin.cpp.
...
Changes to csocoin.cpp
----------------------
csocoin.cpp is the entry point into csocoin-qt, and as such, will require some minor modifications to provide hooks for
