...
* WebSocket: [https://github.com/csocoin-Core/insight-api-csocoin#web-socket-api](https://github.com/csocoin-Core/insight-api-csocoin#web-socket-api)
* API: [https://github.com/csocoin-Core/insight-api-csocoin#swifttx-transactions](https://github.com/csocoin-Core/insight-api-csocoin#swifttx-transactions)
...
By default, the csocoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the csocoin Core daemon:
