...
#   c) node1 mines 32 blocks, so now node 0 has 60001 csocoin, node 1 has 4250 csocoin, node2 has none.
#   d) node0 sends 601 csocoin to node2, in two transactions (301 csocoin, then 300 csocoin).
