...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    /*********************************
     * 		getaddresscsoyaccount
     *********************************/
    BOOST_CHECK_THROW(CallRPC("getaddresscsoyaccount"), runtime_error);
    BOOST_CHECK_NO_THROW(retValue = CallRPC("getaddresscsoyaccount " + strAccount));
