 ...
 * csocoin system. There are three: the main network on which people trade goods
...
public:
    ...
    // const std::vector<unsigned char>& csocoinDevKey() const { return vcsocoinDevKey; }
    // const std::vector<unsigned char>& csocoinFundKey() const { return vcsocoinFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vcsocoinDevKey;
    // std::vector<unsigned char> vcsocoinFundKey;
    // int nDevFee;
    // int nFundFee;
    int nDefaultPort;
