...
public:
    CMainParams()
    {
        ...
        strDevFeeAddress = "CXepcTd6SCmRnbZMFxRUhdAmYy1c3vYDj7";
        ...
        strObfuscationPoolDummyAddress = "CVUJeW7DJRPtzQeBhzHmktRbBgwxVDNyyC";
