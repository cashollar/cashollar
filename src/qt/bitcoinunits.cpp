...
// Copyright (c) 2017-2018 The csocoin Core developers
...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(CSO);
   // unitlist.append(mCSO);
   // unitlist.append(uCSO);
    return unitlist;
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case CSO:
            return QString("CSO");
        case mCSO:
            return QString("Milli-CSO (1 / 1" THIN_SP_UTF8 "000)");
        case uCSO:
            return QString("Micro-CSO (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case CSO:
            return QString("TestCSOs");
        case mCSO:
            return QString("Milli-TestCSOs (1 / 1" THIN_SP_UTF8 "000)");
        case uCSO:
            return QString("Micro-TestCSOs (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
