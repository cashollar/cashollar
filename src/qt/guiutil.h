...
/** Utility functions used by the csocoin Qt UI.
 */
namespace GUIUtil
{
...
// Render csocoin addresses in monospace font
...
// Parse "csocoin:" URI into recipient object, return true on successful parsing
