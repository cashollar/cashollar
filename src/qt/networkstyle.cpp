...
static const struct {
    ...
    {"main", QAPP_APP_NAME_DEFAULT, ":/icons/csocoin", "", ":/images/splash"},
    {"test", QAPP_APP_NAME_TESTNET, ":/icons/csocoin_testnet", QT_TRANSLATE_NOOP("SplashScreen", "[testnet]"), ":/images/splash_testnet"},
    {"regtest", QAPP_APP_NAME_TESTNET, ":/icons/csocoin_testnet", "[regtest]", ":/images/splash_testnet"}};
