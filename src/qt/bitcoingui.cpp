...
QFontDatabase::addApplicationFont(":/fonts/csocoin_font");

QString windowTitle = tr("CSO") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CSO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and CSO: URIs)"));
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CSO wallet"), this);
    aboutAction->setStatusTip(tr("Show information about CSO wallet"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CSO wallet"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CSO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(GUIUtil::getThemeImage(":/icons/transaction_0")), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CSO addresses"));
    ...
    openAction->setStatusTip(tr("Open a CSO: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CSO help message to get a list with possible CSO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CSO client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CSO network", "", count));
}
...
{
    QString strTitle = tr("CSO"); // default title
