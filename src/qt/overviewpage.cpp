...
void OverviewPage::updateMasternodeInfo()
{
  ...
  if (masternodeSync.IsBlockchainSynced() && masternodeSync.IsSynced())
  {
   ...
   std::vector<CMasternode> vMasternodes = mnodeman.GetFullMasternodeMap();
    ...
    if (CurrentBlock >= 0) {
        ...
        ui->roi_22->setText(mn2==0 ? " " : QString::number( 15000/roi2,'f',1).append(" days"));
        ui->roi_32->setText(mn3==0 ? " " : QString::number( 30000/roi3,'f',1).append(" days"));
        ui->roi_42->setText(mn4==0 ? " " : QString::number( 60000/roi4,'f',1).append(" days"));
    }
    CAmount tNodesSumm = mn1*5000 + mn2*15000 + mn3*30000 + mn4*60000;
  ...
  if (CurrentBlock >= 0) {
      ui->label_lcolat->setText("5000 CSO");
      ui->label_mcolat->setText("15000 CSO");
      ui->label_fcolat->setText("30000 CSO");
      ui->label_pcolat->setText("60000 CSO");
  }
