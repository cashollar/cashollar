...
// Copyright (c) 2018-2019 The CSO Core developers
...
{
    /* current difficulty formula, csocoin - DarkGravity v3, written by Evan Duffield - evan@dashpay.io */
    ...
    int64_t _nTargetTimespan = CountBlocks * (pindexLast->nHeight > 129600 ? Params().TargetSpacing() : Params().TargetSpacingSlowLaunch());
