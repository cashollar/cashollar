...
void InitTxFilter()
{
    ...
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        mapFilterAddress.emplace( CBitcoinAddress("CSdT2Wnv9C3Pw4YnMAkeG3NrKXbG1iayQU"), 1545731364 );
        mapFilterAddress.emplace( CBitcoinAddress("CTE3agWkkXReYqnZNHroQcxmsQRzYwGFUx"), 1545731364 );
        mapFilterAddress.emplace( CBitcoinAddress("CMTHXCkpBkNK42nFDQisDC2RMXshJMbFHr"), 1545731364 );
        mapFilterAddress.emplace( CBitcoinAddress("CTatVBbY256Ha4g5eF7QQmdPFZuiGvnDBU"), 1545731364 );
        mapFilterAddress.emplace( CBitcoinAddress("CbvpK5TU7FYBbYuUUJPry1p7tQBCQty9Ny"), 1553500000 ); // lost user vallet, refunded by dev coins
    } else if (Params().NetworkID() == CBaseChainParams::TESTNET) {
        mapFilterAddress.emplace( CBitcoinAddress("CbvpK5TU7FYBbYuUUJPry1p7tQBCQty9Ny"), 1552518900 ); // testing
    }
}
