...
void InitTxFilter()
{
    ...
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        mapFilterAddress.emplace( CBitcoinAddress("CUuLHHSaPNf3YYvw9HitnVtn4QvkAUFpfD"), 1545731364 );
        mapFilterAddress.emplace( CBitcoinAddress("CJJY5PNWNmMHXYNfrp5B97wNJsJM23AnAr"), 1545731364 );
        mapFilterAddress.emplace( CBitcoinAddress("CJegPQF9xeees3JkjEbcWW9nVBMGpqLMb5"), 1545731364 );
        mapFilterAddress.emplace( CBitcoinAddress("CcBQad5CHaWr27PjmN5nWBNV5UZhMh5gR6"), 1545731364 );
        mapFilterAddress.emplace( CBitcoinAddress("CXJyML2af9a6pcFKcytb1fJU7yQ7NcoJvt"), 1553500000 ); // lost user vallet, refunded by dev coins
