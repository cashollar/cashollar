...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* csoc features */
        {"csoc", "masternode", &masternode, true, true, false},
        {"csoc", "listmasternodes", &listmasternodes, true, true, false},
        {"csoc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"csoc", "masternodeconnect", &masternodeconnect, true, true, false},
        {"csoc", "masternodecurrent", &masternodecurrent, true, true, false},
        {"csoc", "masternodedebug", &masternodedebug, true, true, false},
        {"csoc", "startmasternode", &startmasternode, true, true, false},
        {"csoc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"csoc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"csoc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"csoc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"csoc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"csoc", "getmasternodescores", &getmasternodescores, true, true, false},
        {"csoc", "mnsync", &mnsync, true, true, false},
        {"csoc", "spork", &spork, true, true, false},
        {"csoc", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"csoc", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
        ...
        {"wallet", "getaddresscsoyaccount", &getaddresscsoyaccount, true, false, true},
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use csocoind, or the -server option to csocoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"csoc Alert\" admin@foo.com\n"),
...
{
    return "> csocoin-cli " + methodname + " " + args + "\n";
}
