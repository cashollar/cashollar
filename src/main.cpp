...
#if defined(NDEBUG)
#error "csocoin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in ucsocoin) are considered zero fee (for relaying and mining)
...
CAmount GetBlockValue(int nHeight)
{
    ...
    if (Params().NetworkID() == CBaseChainParams::TESTNET){
        ...
        if ( nHeight == 0 ) {
            ...
            nSubsidy = 10 * COIN;
		} else if (nHeight >= 2592001 && nHeight < 3110400) {
            nSubsidy = 5 * COIN;
		} else if (nHeight >= 3110401 && nHeight < 3628800) {
            nSubsidy = 2.5 * COIN;
		} else if (nHeight >= 3628801 && nHeight < 4147200) {
            nSubsidy = 1.25 * COIN;
		} else if (nHeight >= 4147201 && nHeight < 4665600) {
            nSubsidy = 1 * COIN;
		} else if (nHeight >= 4665601 && nHeight < 5184000) {
            nSubsidy = 1 * COIN;
...
int64_t nHeight = 0;
    ...
    } else if (nHeight < 518400 && nHeight > 0)
	{
        ...
        switch(mnlevel) 
			{
            case 1: return blockValue * 0.015;
            case 2: return blockValue * 0.045;
            case 3: return blockValue * 0.09;
            case 4: return blockValue * 0.15;
			}
		}
	}else if (nHeight >= 518400) 
	{
        ...
        switch(mnlevel) 
            ...
            case 2: return blockValue * 0.12;
            case 3: return blockValue * 0.24;
