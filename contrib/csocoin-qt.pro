...
RESOURCES += src/qt/csocoin.qrc src/qt/csocoin_locale.qrc

TRANSLATIONS += src/qt/locale/csocoin_bg.ts \
                src/qt/locale/csocoin_de.ts \
                src/qt/locale/csocoin_en.ts \
                src/qt/locale/csocoin_es.ts \
                src/qt/locale/csocoin_fi.ts \
                src/qt/locale/csocoin_fr.ts \
                src/qt/locale/csocoin_it.ts \
                src/qt/locale/csocoin_ja.ts \
                src/qt/locale/csocoin_pl.ts \
                src/qt/locale/csocoin_pt.ts \
                src/qt/locale/csocoin_ru.ts \
                src/qt/locale/csocoin_sk.ts \
                src/qt/locale/csocoin_sv.ts \
                src/qt/locale/csocoin_vi.ts \
                src/qt/locale/csocoin_zh_CN.ts \
                src/qt/locale/csocoin_zh_TW.ts
